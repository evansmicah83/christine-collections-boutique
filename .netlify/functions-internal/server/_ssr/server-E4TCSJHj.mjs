...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-2IopQbuf.mjs");
...
const manifest = {
  "0ddf57ac23192120a1e98e48f57343c6fe83e8a1ddcf5df54be83354a1f768ad": {
    ...
    importer: () => import("./admin.functions-RXLUqVc2.mjs")
  },
  "573be2cdf3c95bfa88f6bb3d2080ff0b0c620db545ac53f2f5a039a50348d737": {
    functionName: "adminListOrders_createServerFn_handler",
    importer: () => import("./admin.functions-RXLUqVc2.mjs")
  },
  "5a0b01e9603580153d4466db27d3fdfb1126d0b21c0d8a3719cbed076c2eb50a": {
    functionName: "adminUpsertZone_createServerFn_handler",
    importer: () => import("./admin.functions-RXLUqVc2.mjs")
  },
  "5d4e304b03fe5094aebf06651582ae3142336a7785c9d8d42a6820db561ed7e2": {
    functionName: "adminDeleteZone_createServerFn_handler",
    importer: () => import("./admin.functions-RXLUqVc2.mjs")
  },
  "66f2c0628bd74497e0aeab4851b15256225c2ab5d34f9d0cb1ebd04510b72c32": {
    functionName: "listDeliveryZones_createServerFn_handler",
    importer: () => import("./catalog.functions-vWPEbCuw.mjs")
  },
  "6bada778c941c28d8f4bb5693567682fcc0a8cc5f8e134db94c3d77ba2454fce": {
    functionName: "adminUpsertCategory_createServerFn_handler",
    importer: () => import("./admin.functions-RXLUqVc2.mjs")
  },
  "6c8a93162baf5f19a0104a3fbb4ef5b118f9a0e1e73268385aa11ec42041ca24": {
    functionName: "getMyOrders_createServerFn_handler",
    importer: () => import("./orders.functions-CLg9kGBB.mjs")
  },
  "7e72b79098fc3326e7f71b7e23123c5185651ff03658c9596abb0867fd56e7d2": {
    functionName: "mpesaStkPush_createServerFn_handler",
    importer: () => import("./mpesa.functions-DuiOPE2N.mjs")
  },
  ...
  "8fcb0253bf3c1c167b9da7ce06410812f0527d2f561cf0a09fe48379367bcb16": {
  ...
  "9362363b29a3bc3bc513493348dba611bc6f746446ffba70e7db843b6f60ccdb": {
    functionName: "mpesaStatus_createServerFn_handler",
    importer: () => import("./mpesa.functions-DuiOPE2N.mjs")
  },
  ...
  "a5ee9bad6d6dfcd1a5c1f0a85084988327f42fcacbc4a074a617434a490158db": {
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-Y4HKzRjc.mjs"),
    import("./start-DlZvunVA.mjs"),
